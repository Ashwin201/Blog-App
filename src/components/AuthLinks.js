    ...
    <>
      {status === "authenticated" || status === "loading" ? (
        <ul className=" sm:flex mb-2 sm:mb-0  items-center justify-center align-middle ">
          ...
          <li
            onClick={signOut}
            className="list-none  sm:inline sm:ml-5 cursor-pointer font-medium text-lg sm:text-base mt-5 sm:mt-0 bg-black text-white   border-2 rounded-md border-black dark:border-white hover:scale-90 hover:bg-white hover:text-black px-2 py-1  transition-all duration-500 ease-in-out"
          >
            Log out
          </li>
        </ul>
